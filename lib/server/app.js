	...
	if (env.settings.isEnabled('cors')) {
		...
		app.use(function allowCrossDomain(req, res, next) {
			...
			res.header(
				...
				'access-control-allow-origin,Access-Control-Allow-Headers, access-control-allow-methods, Content-Type, Authorization, Content-Length, X-Requested-With, api-secret',
			);
