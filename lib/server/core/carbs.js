...
module.exports = function (env, lastMeals) {
	var karbs = lastMeals||[];
	const carbAbsTime = parseInt(env.CARBS_ABS_TIME); // meal absoption time in min defautl 360 or 6 hours
	...
	// const fs = require('fs');
	// fs.writeFile('./files/latest_carbs.json', carbrateString, function (err) {
