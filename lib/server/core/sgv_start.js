...
, }, env) => {
  ...
  var oldTime = entries && entries[0] ? moment(entries[0].mills) : moment().add(-5, 'minutes');
  ...
  var sgv_pump = Math.floor(oldSgv + (BGI_ins * 18) + (liver_bgi * 18) + (carbs * 18) + (noise * 18));
  ...
  console.log('-------------------------------------------');
  console.log('total BG impact of insulin for ' + deltaMinutes + ' minutes:', BGI_ins, 'mg/dl');
  ...
  console.log('this is the pump basal insulin activity:', pumpBasalAct * deltaMinutes * 18);
