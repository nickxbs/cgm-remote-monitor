...
function init (client, $) {
  ...
  careportal.toggleDrawer = function toggleDrawer (event) {
    client.browserUtils.toggleDrawer('#cgmsimDrawer', careportal.prepare);
    maybePrevent(event);
  };

  $('#cgmsimDrawerToggle').click(careportal.toggleDrawer);
  $('#cgmsimDrawer').find('button').click(careportal.save);
